import type { Part, PartState, AppState, SavedData } from './types';
...
export function saveToStorage(parts: Part[], state: AppState): void {
  try {
 ...
 */
export function buildState(parts: Part[], saved: AppState | undefined): AppState {
