...
export const PART_NUMBER_FAMILY_LOOKUP = [
...
export function inferPlaceholderPn(partName) {
    const prefix = partName.split('-')[0]?.toLowerCase() ?? '';
    const rule = PART_NUMBER_FAMILY_LOOKUP.find(r => r.filenamePrefix === prefix);
